...
--
-- Your thinking:
-- ใช้คำสั่ง SELECT เพื่อเรียกดึงข้อมูลมา โดยกำหนดให้ดึงแค่ name และ price
-- ใช้ FROM เพิ่งชี้ว่าเอามาจากตารางไหน
-- กำหนดเงื่อนไขโดยการใช้ WHERE และตั้งเงื่อนไขให้ category มีค่าเท่ากับ Side
--